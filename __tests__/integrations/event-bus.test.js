...
describe.skip('EventBus', () => {
  ...
  describe('Event Emission and Subscription', () => {
    ...
    it('should support wildcard event subscriptions', () => {
      ...
      expect(wildcard_handler).toHaveBeenCalledWith('any-event', { test: true });
      expect(wildcard_handler).toHaveBeenCalledWith('another-event', { test: false });
    });
    ...
    it('should support namespace pattern subscriptions', () => {
      ...
      expect(namespace_handler).not.toHaveBeenCalledWith(expect.anything(), { id: 3 });
    });
  ...
  describe('Event Routing', () => {
    ...
    it('should transform events during routing', async () => {
      ...
      event_bus.add_route('source:event', 'target:event', handler, { transformer });
  ...
  describe('Event Queuing', () => {
    ...
    it('should respect queue size limits', () => {
      ...
      expect(() => event_bus.emit('event', { n: 3 })).toThrow('Event queue is full');
    });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle async handler errors', async () => {
      const async_error_handler = jest.fn().mockRejectedValue(new Error('Async error'));
